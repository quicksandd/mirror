    ...
    <section id="trust" className="section section--soft" aria-labelledby="trust-title">
      <div className="container-wide">
        ...
        <div className="trust-cta">
          <a className="btn btn--github trust-github-btn" href={config.githubUrl} target="_blank" rel="noopener noreferrer">
        ...
        <div className="founders-grid">
          {[
            ...
            <div key={p.name} className="founder-card">
              <div className="founder-avatar">
                <img src={p.img} alt={p.name} onError={(e)=>{e.currentTarget.style.display='none'}} />
              </div>
              <div className="founder-name">{p.name}</div>
              <div className="founder-caption">{p.cap}</div>
              <a className="btn founder-link" href={p.link} target="_blank" rel="noopener noreferrer">
